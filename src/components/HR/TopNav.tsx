...
const mockNotifications: Notification[] = [
  {
    ...
    message: 'John Doe submitted a leave request for next week',
    type: 'info',
  ...
  },
  {
    ...
    message: '3 employee documents will expire in 7 days',
    type: 'warning',
  ...
  },
  {
    ...
    message: 'New hire Jane Smith completed onboarding',
    type: 'success',
    timestamp: '1 day ago',
    isRead: true
  },
  {
    ...
    message: '5 employees late to work today',
    type: 'warning',
    timestamp: '1 day ago',
    isRead: true
  },
  {
    ...
    message: 'New remote work policy available for review',
    type: 'info',
...
export const TopNav = ({ className = '', onMenuClick, showMenuButton = false }: TopNavProps) => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    // Implement HR-specific search functionality
  }
      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:flex items-center space-x-2">
            <button className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-md transition-colors" title="New Employee">
              <span className="text-lg">👤</span>
            </button>
            <button className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-md transition-colors" title="Leave Calendar">
              <span className="text-lg">📅</span>
            </button>
            <button className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-md transition-colors" title="Reports">
              <span className="text-lg">📊</span>
            </button>
          </div>
              ...
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                ...
                <div className="border-t border-gray-200 py-2">
                  <button
                    onClick={() => {
                      // Handle logout
                      console.log('HR user logging out...')
                    }}
