...
const mockNotifications: Notification[] = [
  {
    id: '1',
    title: 'Task Assigned',
    message: 'You have been assigned to "Fix Login Bug" task',
    type: 'info',
  ...
  },
  {
    ...
    message: 'Your "Update Dashboard" task was approved',
    type: 'success',
  ...
  },
  {
    ...
    message: 'New requirements added to "Mobile App" project',
    type: 'warning',
    timestamp: '1 day ago',
    isRead: false
  },
  {
    ...
    message: 'Your leave request for Aug 15-16 was approved',
    type: 'success',
      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-4">
          <div className="hidden md:flex items-center space-x-2">
            <button className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-md transition-colors" title="New Task">
              <span className="text-lg">➕</span>
            </button>
            <button className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-md transition-colors" title="Time Tracker">
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              ...
              <div className="hidden md:block text-left">
                ...
                <p className="text-xs text-gray-500">developer@company.com</p>
              </div>
